        ...
        <div className='flex flex-col gap-y-4 pr-10 mt-5'>
            ...
            <div className='flex gap-x-4'>
                ...
                <div className='flex flex-col items-center justify-center'>
                    <div className='font-bold text-lg text-dark'>محمدرضا مقدر</div>
            ...
            <form action="" className='px-12'>
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-y-4 gap-x-2 md:gap-x-10 justify-center md:px-10'>
                    <div className='w-full flex flex-col gap-y-1'>
                        ...
                        <input id='username' type="text" className='p-2 border-2 border-gray rounded w-full outline-none text-xs md:text-base placeholder:text-xs md:placeholder:text-base' placeholder='نام کاربری خود را وارد کنید' />
                    </div>
                    <div className='w-full flex flex-col gap-y-1'>
                        ...
                        <input type="email" id='email' className='p-2 border-2 border-gray rounded w-full outline-none text-xs md:text-base placeholder:text-xs md:placeholder:text-base' placeholder='ایمیل خود را وارد کنید' />
                    </div>
                    <div className='w-full flex flex-col gap-y-1'>
                        ...
                        <input type="password" id='pass' className='p-2 border-2 border-gray rounded w-full outline-none text-xs md:text-base placeholder:text-xs md:placeholder:text-base' placeholder='ایمیل خود را وارد کنید' />
                    </div>
                    <div className='w-full flex flex-col gap-y-1'>
                        ...
                        <input type="password" id='return-pass' className='p-2 border-2 border-gray rounded w-full outline-none text-xs md:text-base placeholder:text-xs md:placeholder:text-base' placeholder='ایمیل خود را وارد کنید' />
                    </div>
